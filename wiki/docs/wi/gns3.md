...
<ImageZoom src="https://i0.wp.com/brianlinkletter.com/wp-content/uploads/2015/07/GNS3-v1x-064.png?fit=833%2C582&ssl=1" />
...
Последняя версия GNS3 в репозитории Альт - 2.2.60, а последняя версия в целом 3.1.0 (https://repology.org/project/gns3-gui/versions), соответственно, будьте внимательны с версией GNS3 VM. Если будет несовпадение, то и работать не будет
:::

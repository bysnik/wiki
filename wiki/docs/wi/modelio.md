...
<ImageZoom src="https://das6sa3.wordpress.com/wp-content/uploads/2017/01/logo-sponsor-modeliosoft.png" />
...
<ImageZoom src="/img/modelio.png" />

Но под обычным пользователем его плющит не по детски:
<ImageZoom src="/img/modelio-1.png" />
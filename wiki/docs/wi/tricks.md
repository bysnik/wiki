...
зацепка это тег BUILDHOST. Каждому тимовцу и иной официальной сущность дается свой, но все они в сборочнице.. и у всех домен altinux.org
на выходе csv из левых пакетов - имя пакета - хостгдесобран

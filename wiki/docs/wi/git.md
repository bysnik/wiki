...
Для того, чтобы можно было использовать данный GPG-ключ на хостингах, требуется, чтобы электронная почта аккаунта на хостинге и электронная почта ключа GPG были одинаковыми!
:::

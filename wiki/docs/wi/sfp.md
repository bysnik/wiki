...
# Заметки о поддержке SFP в Linux

title: "Устранение проблемы с неподдерживаемым модулем SFP+"
source: "https://help.cesbo.com/ru/misc/articles/hardware/unsupported-sfp-module"

## Устранение проблемы с неподдерживаемым модулем SFP+

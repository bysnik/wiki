...
title: "Exploring Tokimeki Memorial: Tools and resources for PSX reverse-engineering"
source: "https://tetracorp.github.io/tokimeki-memorial/methods/tools-resources.html#psx-file-format-conversion-tools"
author:
published:
created: 2026-07-13
description:
...
The following is a list of tools and documents useful for analyzing, modding or translating PlayStation games. Many of them are conveniently available in Linux by a package manager like `apt`.
...
Commercial decompiler. There’s a [free](https://www.hex-rays.com/products/ida/support/download_freeware/) version but it only supports x86/64 and not MIPS (PSX). [ghidra\_psx\_ldr](https://github.com/lab313ru/ghidra_psx_ldr)
...
A collection of documentation about the PSX hardware and history from 2000 (originally [here](https://web.archive.org/web/20011211221846/http://www.execpc.com/~halkun/PSX/index.html)).
...
[« Back to index page](https://tetracorp.github.io/tokimeki-memorial/)
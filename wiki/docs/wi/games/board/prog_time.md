# <font color="red">⚂</font> programming time <font color="red">⚂</font>
...
- колода: [easy.html](easy.html)
- код: [programming-time](https://github.com/jackdoe/programming-for-kids/tree/master/projects/programming-time/decks/easy)
- память: [memory.txt](memory.txt)
- шпаргалка: [cheatsheet.txt](cheatsheet.txt)
- автор: [github.com/jackdoe](https://github.com/jackdoe)
- соавтор: Jackie (10 лет), идея игры принадлежала ей, и она помогала с реализацией
- контакт: [programmingtime@fastmail.com](mailto:programmingtime@fastmail.com)
- лицензия: CC BY 4.0
...
> **P.S.:** Лицевая и оборотная стороны обложки представляют собой ASCII-строку.
...
Либо создавайте переменные окружения, что будет правильнее, либо вписывайтся значения вместо переменных:
GITEA_INSTANCE_URL - ЮРЛ Вашего Гитеа, например http://192.168.0.1:3000

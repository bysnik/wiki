...
Ну что вы, у редиски же тоже проприетарная лицензия, ну как жк так... Я в поисках альтернативы...
...
<table id="program-table">
    ...
    <tbody> <!-- Содержимое рабочей программы -->
        ...
        <tr>
            <td>Базы данных типа ключ-значение. Резидентная СУБД Redis</td>
            <td>2</td>
            <td>2</td>
        </tr>
        <tr>
...
### 1. Классификация баз данных. Доступ к данным


### 2. Архитектура СУБД


### 3. Теоретические основые нереляционных баз данных

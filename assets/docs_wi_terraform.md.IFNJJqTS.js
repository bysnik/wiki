...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div><p>Don&#39;t forget to run <code>terraform init</code> each time you rebuild the provider. Check <a href="https://www.youtube.com/watch?v=TMmovxyo5sY&amp;t=30m14s" target="_blank" rel="noreferrer">here</a> for a more detailed explanation.</p><p>You can check the latest released version of a provider at <a href="https://releases.hashicorp.com/terraform-provider-docker/" target="_blank" rel="noreferrer">https://releases.hashicorp.com/terraform-provider-docker/</a>.</p><h2 id="developing-on-windows" tabindex="-1">Developing on Windows <a class="header-anchor" href="#developing-on-windows" aria-label="Permalink to &quot;Developing on Windows&quot;">​</a></h2><p>You can build and test on Widows without <code>make</code>. Run <code>go install</code> to build and <code>Scripts\\runAccTests.bat</code> to run the test suite.</p><p>Continuous integration for Windows is not available at the moment due to lack of a CI provider that is free for open source projects <em>and</em> supports running Linux containers in Docker for Windows. For example, AppVeyor is free for open source projects and provides Docker on its Windows builds, but only offers Linux containers on Windows as a paid upgrade.</p><h2 id="зеркало" tabindex="-1">ЗЕРКАЛО <a class="header-anchor" href="#зеркало" aria-label="Permalink to &quot;ЗЕРКАЛО&quot;">​</a></h2><p>Есть несколько способов организовать такое зеркало, от самого простого до полностью автоматизированного. Я опишу основные подходы.</p><h3 id="способ-1-локальное-фаиловое-зеркало-filesystem-mirror" tabindex="-1">Способ 1: Локальное файловое зеркало (Filesystem Mirror) <a class="header-anchor" href="#способ-1-локальное-фаиловое-зеркало-filesystem-mirror" aria-label="Permalink to &quot;Способ 1: Локальное файловое зеркало (Filesystem Mirror)&quot;">​</a></h3><p>Этот метод подходит для изолированных сред (air-gapped) или когда нужно просто создать локальную копию провайдеров на диске.</p><p><strong>1. Скачайте провайдеры в директорию:</strong></p><p>Используйте встроенную команду <code>terraform providers mirror</code> или <code>tofu providers mirror</code>. Она скачает все провайдеры, необходимые для вашей текущей конфигурации, и создаст нужную структуру каталогов.</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># Для Terraform</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">terraform</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> providers</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> mirror</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> /path/to/mirror/directory</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># Для OpenTofu</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">tofu</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> providers</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> mirror</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> /path/to/mirror/directory</span></span></code></pre></div><p>По умолчанию скачиваются версии для вашей текущей платформы. Чтобы добавить другие (например, <code>linux_amd64</code>), используйте флаг <code>-platform</code>:</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">tofu</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> providers</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> mirror</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -platform=linux_amd64</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -platform=darwin_arm64</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> /path/to/mirror/directory</span></span></code></pre></div><p><strong>2. Настройте клиенты (Terraform/OpenTofu) для использования этого зеркала:</strong></p><p>Создайте или отредактируйте файл конфигурации CLI (<code>~/.terraformrc</code> для Terraform, <code>~/.tofurc</code> для OpenTofu).</p><div class="language-hcl vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">hcl</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">provider_installation</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> {</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">  filesystem_mirror</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> {</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    path</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> =</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &quot;/path/to/mirror/directory&quot;</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">  }</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div><p>Теперь <code>terraform init</code> или <code>tofu init</code> будут искать провайдеры только в этой локальной директории.</p><h3 id="способ-2-сетевои-mirror-сервер-network-mirror" tabindex="-1">Способ 2: Сетевой mirror-сервер (Network Mirror) <a class="header-anchor" href="#способ-2-сетевои-mirror-сервер-network-mirror" aria-label="Permalink to &quot;Способ 2: Сетевой mirror-сервер (Network Mirror)&quot;">​</a></h3><p>Этот метод удобен для командной работы, так как зеркало размещается на общем сервере и доступно по сети.</p><p><strong>Вариант А: Использовать готовое решение</strong></p><p>Существуют готовые сервисы, реализующие <a href="https://developer.hashicorp.com/terraform/internals/provider-network-mirror-protocol" target="_blank" rel="noreferrer">протокол Network Mirror Protocol</a>. Один из примеров — проект <a href="https://github.com/jonasasx/terraform-registry-mirror" target="_blank" rel="noreferrer">terraform-registry-mirror</a>.</p><p>Его можно легко запустить с помощью Docker:</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">docker</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> run</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -d</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -p</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> 8080:8080</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> ghcr.io/jonasasx/terraform-registry-mirror:0.0.9</span></span></code></pre></div><p>После запуска настройте клиенты на использование этого mirror-сервера, указав его URL:</p><div class="language-hcl vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">hcl</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">provider_installation</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> {</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">  network_mirror</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> {</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    url</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> =</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &quot;https://ваш-сервер:8080/&quot;</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">  }</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div><p><strong>Вариант Б: Создать свой Network Mirror из файлового зеркала</strong></p><p>Если вы уже создали файловое зеркало (как в Способе 1), его можно превратить в сетевой mirror. Команда <code>providers mirror</code> автоматически генерирует JSON-индексы, необходимые для работы протокола. Вам останется только разместить всю директорию на любом статическом веб-сервере (например, Nginx) и настроить клиентов на его URL, используя блок <code>network_mirror</code>, как показано выше.</p><h3 id="способ-3-зеркало-в-oci-реестре-oci-registry-mirror" tabindex="-1">Способ 3: Зеркало в OCI-реестре (OCI Registry Mirror) <a class="header-anchor" href="#способ-3-зеркало-в-oci-реестре-oci-registry-mirror" aria-label="Permalink to &quot;Способ 3: Зеркало в OCI-реестре (OCI Registry Mirror)&quot;">​</a></h3><p>OpenTofu (начиная с некоторых версий) и Terraform (экспериментально) поддерживают установку провайдеров из OCI-реестров, таких как Docker Hub, JFrog Artifactory или GitLab Container Registry.</p><p><strong>1. Настройте клиент OpenTofu:</strong></p><p>В конфигурационном файле (<code>~/.tofurc</code>) укажите блок <code>oci_mirror</code>:</p><div class="language-hcl vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">hcl</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">provider_installation</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> {</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">  oci_mirror</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> {</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    repository_template</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> =</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &quot;my-registry.com/opentofu-providers/</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">\${</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">namespace</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">}</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">/</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">\${</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">type</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">}</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    include</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> =</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> [</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;registry.opentofu.org/*/*&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">]</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">  }</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">}</span></span></code></pre></div><p>В этом примере OpenTofu будет искать провайдеры в OCI-репозитории <code>my-registry.com/opentofu-providers/</code>.</p><p><strong>2. Наполните OCI-репозиторий провайдерами:</strong></p><p>Вам нужно будет самостоятельно загрузить образы провайдеров в ваш OCI-реестр, соблюдая структуру тегов (версии) и манифестов, описанную в <a href="https://opentofu.org/docs/cli/oci_registries/provider-mirror/" target="_blank" rel="noreferrer">документации OpenTofu</a>.</p>`,101))])}const f=i(h,[["render",c]]);export{F as __pageData,f as default};

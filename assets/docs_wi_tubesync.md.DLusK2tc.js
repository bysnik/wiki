import{_ as n,C as p,o as l,c as h,j as i,a as k,G as t,aj as e}from"./chunks/framework.BZR1KcQy.js";const C=JSON.parse('{"title":"TubeSync","description":"","frontmatter":{},"headers":[],"relativePath":"docs/wi/tubesync.md","filePath":"docs/wi/tubesync.md","lastUpdated":1788533046000}'),E={name:"docs/wi/tubesync.md"};function r(d,s,y,g,F,c){const a=p("ImageZoom");return l(),h("div",null,[s[0]||(s[0]=i("h1",{id:"tubesync",tabindex:"-1"},[k("TubeSync "),i("a",{class:"header-anchor",href:"#tubesync","aria-label":'Permalink to "TubeSync"'},"​")],-1)),t(a,{src:"https://mariushosting.com/wp-content/uploads/2022/01/TubeSync-Synology-NAS-Set-up-6-new.png"}),s[1]||(s[1]=e(`<p><a href="https://github.com/meeb/tubesync" target="_blank" rel="noreferrer">https://github.com/meeb/tubesync</a></p><h2 id="конфиг-пользовательского-приложения-для-truenas-scale" tabindex="-1">Конфиг пользовательского приложения для TrueNAS SCALE <a class="header-anchor" href="#конфиг-пользовательского-приложения-для-truenas-scale" aria-label="Permalink to &quot;Конфиг пользовательского приложения для TrueNAS SCALE&quot;">​</a></h2><div class="language-yaml vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">yaml</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">configs</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">:</span></span>

...
<span class="line"><span>- Initial build for ALT Linux</span></span></code></pre></div><h3 id="собираем-пакет" tabindex="-1">Собираем пакет <a class="header-anchor" href="#собираем-пакет" aria-label="Permalink to &quot;Собираем пакет&quot;">​</a></h3><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">rpmbuild</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -ba</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> ~/RPM/SPECS/dupeguru.spec</span></span></code></pre></div>`,22)]))}const g=a(e,[["render",t]]);export{u as __pageData,g as default};

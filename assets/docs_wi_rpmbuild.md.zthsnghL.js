...
<span class="line"><span>%__gpg_sign_cmd %{__gpg} --batch --no-verbose --no-armor --no-secmem-warning -u &quot;%{_gpg_name}&quot; -sbo %{__signature_filename} %{__plaintext_filename}</span></span>
<span class="line"><span>%_gpg_name Nikita Bystrov &lt;bystrovno@basealt.ru&gt;</span></span></code></pre></div></div><h2 id="подпись-собранного-пакета" tabindex="-1">Подпись собранного пакета <a class="header-anchor" href="#подпись-собранного-пакета" aria-label="Permalink to &quot;Подпись собранного пакета&quot;">​</a></h2><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">rpm</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> --addsign</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> ~/RPM/RPMS/x86_64/packagename.rpm</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># или</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">rpmbuild</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -ba</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> --sign</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> ~/RPM/RPMS/x86_64/packagename.rpm</span></span></code></pre></div><h3 id="автоматическая-подпись-после-сборки-через-rpmmacros" tabindex="-1">Автоматическая подпись после сборки (через ~/.rpmmacros) <a class="header-anchor" href="#автоматическая-подпись-после-сборки-через-rpmmacros" aria-label="Permalink to &quot;Автоматическая подпись после сборки (через ~/.rpmmacros)&quot;">​</a></h3><p>Добавьте в <code>~/.rpmmacros</code>:</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">%__rpmhook_posttrans</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> /usr/lib/rpm/posttrans.d/sign-rpms.sh</span></span></code></pre></div><h2 id="сборка-пакета-с-простыми-фаилами" tabindex="-1">Сборка пакета с простыми файлами <a class="header-anchor" href="#сборка-пакета-с-простыми-фаилами" aria-label="Permalink to &quot;Сборка пакета с простыми файлами&quot;">​</a></h2><p>Пример простого RPM-пакета для <strong>ALT Linux</strong>, который устанавливает <strong>обои рабочего стола</strong> и может использоваться как <strong>branding-пакет</strong> (например, <code>mycompany-wallpapers</code>).</p><h3 id="пример-структуры-архива" tabindex="-1">Пример структуры архива <a class="header-anchor" href="#пример-структуры-архива" aria-label="Permalink to &quot;Пример структуры архива&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>mycompany-wallpapers-1.0/</span></span>
...
<span class="line"><span>    └── light.jpg</span></span></code></pre></div><h3 id="mycompany-wallpapers-spec" tabindex="-1"><code>mycompany-wallpapers.spec</code> <a class="header-anchor" href="#mycompany-wallpapers-spec" aria-label="Permalink to &quot;\`mycompany-wallpapers.spec\`&quot;">​</a></h3><div class="language-rpm-spec vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">rpm-spec</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">%define</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> wallpaper_dir /usr/share/backgrounds/mycompany</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">Name:</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">           mycompany-wallpapers</span></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">Version:</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">        1.0</span></span>
...
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">Summary:</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">        MyCompany Branding Wallpapers</span></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">Group:</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">          User Interface/Desktops</span></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">License:</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">        Proprietary</span></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">Url:</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">            https://mycompany.example.com/</span></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">BuildArch:</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">      noarch</span></span>
<span class="line"></span>
...
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">BuildRequires:</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">  rpm-build</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">%description</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">Official wallpapers for MyCompany desktop branding.</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">%prep</span></span>
<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">%setup</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> -q</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">%install</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">#</span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"> Создаём корневой каталог для обоев</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">install</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -d</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -m</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> 0755</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> %{buildroot}%{wallpaper_dir}</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">#</span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"> Копируем всё содержимое (включая подкаталоги) в целевой каталог</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">cp</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -r</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> ./</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">*</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> %{buildroot}%{wallpaper_dir}/</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">#</span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"> Убеждаемся, что права корректны</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">chmod</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -R</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> u+rwX,go+rX,go-w</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> %{buildroot}%{wallpaper_dir}</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">%files</span></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">%doc</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> %{wallpaper_dir}/README</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">%{wallpaper_dir}/</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">%changelog</span></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">*</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> Wed Oct 15 2025 Nikita Bystrov </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">&lt;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">bystrovno@basealt.ru</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">&gt;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> 1.0-alt1</span></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">-</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> Initial</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> wallpaper</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> package</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> with</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> archive-based</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> source</span></span></code></pre></div><h3 id="сборка-пакета" tabindex="-1">Сборка пакета <a class="header-anchor" href="#сборка-пакета" aria-label="Permalink to &quot;Сборка пакета&quot;">​</a></h3><p>Скопируйте spec и источники</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">cp</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> mycompany-wallpapers.spec</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> ~/RPM/SPECS/</span></span>

import{_ as n,C as p,c as l,o as h,j as i,G as k,aj as t,a as e}from"./chunks/framework.BZR1KcQy.js";const C=JSON.parse('{"title":"TubeSync","description":"","frontmatter":{},"headers":[],"relativePath":"docs/wi/tubesync.md","filePath":"docs/wi/tubesync.md","lastUpdated":1788526571000}'),E={name:"docs/wi/tubesync.md"};function r(d,s,y,g,F,c){const a=p("ImageZoom");return h(),l("div",null,[s[0]||(s[0]=i("h1",{id:"tubesync",tabindex:"-1"},[e("TubeSync "),i("a",{class:"header-anchor",href:"#tubesync","aria-label":'Permalink to "TubeSync"'},"​")],-1)),k(a,{src:"https://mariushosting.com/wp-content/uploads/2022/01/TubeSync-Synology-NAS-Set-up-6-new.png"}),s[1]||(s[1]=t(`<p><a href="https://github.com/meeb/tubesync" target="_blank" rel="noreferrer">https://github.com/meeb/tubesync</a></p><h2 id="конфиг-пользовательского-приложения-для-truenas-scale" tabindex="-1">Конфиг пользовательского приложения для TrueNAS SCALE <a class="header-anchor" href="#конфиг-пользовательского-приложения-для-truenas-scale" aria-label="Permalink to &quot;Конфиг пользовательского приложения для TrueNAS SCALE&quot;">​</a></h2><div class="language-yaml vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">yaml</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">configs</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">:</span></span>
...
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">    scheme</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">http</span></span></code></pre></div><p>Вместо <code>/mnt/first/4r3ewfer/tubesync/downloads</code> и <code>/mnt/first/4r3ewfer/tubesync/config</code> используйте собственные пулы.</p>`,4))])}const D=n(E,[["render",r]]);export{C as __pageData,D as default};

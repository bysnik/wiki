...
<span class="line"><span>      dist_upgrade: true</span></span>
<span class="line"><span>      update_kernel: true</span></span>
<span class="line"><span>      clean: true</span></span></code></pre></div><p><strong>Примечание:</strong> Используется <a href="https://docs.ansible.com/ansible/latest/collections/community/general/apt_rpm_module.html" target="_blank" rel="noreferrer">модуль apt_rpm</a>.</p><h3 id="пример-с-установкои-и-настроикои-xrdp-server-через-роль" tabindex="-1">Пример с установкой и настройкой xrdp-server через роль <a class="header-anchor" href="#пример-с-установкои-и-настроикои-xrdp-server-через-роль" aria-label="Permalink to &quot;Пример с установкой и настройкой xrdp-server через роль&quot;">​</a></h3><p>Структура проекта:</p><p>xrdp-server.yaml - главный запускатор, пусть лежит в любом месте.</p><p>/etc/ansible/roles/xrdp-server/ - директория роли</p><p>/etc/ansible/roles/xrdp-server/tasks/main.yml - основной плейбук роли /etc/ansible/roles/xrdp-server/vars/main.yml - там у меня буквально одна переменная чисто подстраховаться</p><p>/etc/ansible/roles/xrdp-server/всё-остальное - тут у меня всё пусто, чисто как было создано командой ansible-galaxy</p><h4 id="xrdp-server-yaml" tabindex="-1">xrdp-server.yaml <a class="header-anchor" href="#xrdp-server-yaml" aria-label="Permalink to &quot;xrdp-server.yaml&quot;">​</a></h4><p>::: detail</p><div class="language-yaml vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">yaml</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">- </span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">hosts</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">rdp_server</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">  roles</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">:</span></span>
...
<span class="line"><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">              63306638373134303961353364333131386361653064306364346265313334353436303239373838</span></span>
<span class="line"><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">              62346136656161653430383730663661393830313430343539366663383431626365633465376436</span></span>
<span class="line"><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">              35396137323135613661</span></span></code></pre></div><p>:::</p><h4 id="etc-ansible-roles-xrdp-server-tasks-main-yml" tabindex="-1">/etc/ansible/roles/xrdp-server/tasks/main.yml <a class="header-anchor" href="#etc-ansible-roles-xrdp-server-tasks-main-yml" aria-label="Permalink to &quot;/etc/ansible/roles/xrdp-server/tasks/main.yml&quot;">​</a></h4><p>::: detail</p><div class="language-yaml vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">yaml</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">#SPDX-License-Identifier: MIT-0</span></span>

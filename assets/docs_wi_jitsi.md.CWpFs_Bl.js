...
<span class="line"><span>Server: Jetty(9.4.15.v20190215)</span></span></code></pre></div><p>Если всё сделано правильно, jicofo на healthcheck-запрос будет отдавать HTTP-код 200.</p><h2 id="настроика-веб-приложения-jitsi-meet" tabindex="-1">Настройка веб-приложения Jitsi Meet <a class="header-anchor" href="#настроика-веб-приложения-jitsi-meet" aria-label="Permalink to &quot;Настройка веб-приложения Jitsi Meet&quot;">​</a></h2><p>Получить SSL/TLS-сертификат для домена.</p><p><strong>Примечание</strong></p><p>Можно создать сертификат без обращения к УЦ. При использовании такого сертификата в браузере будут выводиться предупреждения.</p><p>Для создания самоподписанного сертификата следует:</p><ul><li>создать корневой ключ:<div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># openssl genrsa -out rootCA.key 2048</span></span></code></pre></div></li><li>создать корневой сертификат:<div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># openssl req -x509 -new -key rootCA.key -days 10000 -out rootCA.crt -subj &quot;/C=RU/ST=Russia/L=Moscow/CN=SuperPlat CA Root&quot;</span></span></code></pre></div></li><li>сгенерировать ключ:<div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># openssl genrsa -out jitsi2.test.alt.key 2048</span></span></code></pre></div></li><li>создать запрос на сертификат (тут важно указать имя сервера: домен или IP):<div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># openssl req -new -key jitsi2.test.alt.key -out jitsi2.test.alt.csr -subj &quot;/C=RU/L=Moscow/CN=jitsi2.test.alt&quot;</span></span></code></pre></div></li><li>подписать запрос на сертификат корневым сертификатом:<div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># openssl x509 -req -in jitsi2.test.alt.csr -CA rootCA.crt -CAkey rootCA.key -CAcreateserial -out jitsi2.test.alt.crt -days 5000</span></span>
<span class="line"><span>Signature ok</span></span>
<span class="line"><span>subject=C = RU, CN = jitsi2.test.alt</span></span>
<span class="line"><span>Getting CA Private Key</span></span></code></pre></div></li></ul><p>Положить ключ и сертификат в папку <code>/etc/jitsi/meet/</code>:</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># cp jitsi2.test.alt.crt /etc/jitsi/meet/</span></span>

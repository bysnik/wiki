...
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">beep</span></span></code></pre></div><blockquote><p>Утилита <code>beep</code> может потребовать установки и прав на <code>/dev/input/by-path/...</code>.</p></blockquote><h2 id="皆さんこんにちは-устанавливаем-поддержку-нормальнои-японскои-раскладки" tabindex="-1">皆さんこんにちは！ Устанавливаем поддержку нормальной японской раскладки <a class="header-anchor" href="#皆さんこんにちは-устанавливаем-поддержку-нормальнои-японскои-раскладки" aria-label="Permalink to &quot;皆さんこんにちは！ Устанавливаем поддержку нормальной японской раскладки&quot;">​</a></h2><p>mozc позволит печатать romaji и получать навыходе хирагану, катакану и, соответственно, кандзи.</p><p>Я настраивал это только в KDE Plasma 6</p><ol><li>Устанавливаем необходимые пакеты:</li></ol><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">apt-get</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> install</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> fcitx5-qt</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> fcitx5-configtool</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> fcitx5</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> fcitx5-gtk</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> fcitx5-mozc</span></span></code></pre></div><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"></span></code></pre></div><ol start="2"><li>Редактируем файл:</li></ol><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">nano</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> ~/.bash_profile</span></span></code></pre></div><p>Добавляем строки:</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">export</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> GTK_IM_MODULE</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">fcitx5</span></span>

...
const grammar = {
  ...
  patterns: [
    {
      captures: {1: {name: 'entity.name.type.stan'}},
      match:
  ...
  repository: {
      ...
      patterns: [
        {
          ...
          match:
            '(~)(\\s*)(bernoulli|bernoulli_logit|bernoulli_logit_glm|beta|beta_binomial|beta_neg_binomial|beta_proportion|binomial|binomial_logit|binomial_logit_glm|categorical|categorical_logit|categorical_logit_glm|cauchy|chi_square|dirichlet|dirichlet_multinomial|discrete_range|double_exponential|exp_mod_normal|exponential|frechet|gamma|gaussian_dlm_obs|gumbel|hypergeometric|inv_chi_square|inv_gamma|inv_wishart|inv_wishart_cholesky|laplace_marginal_bernoulli_logit|laplace_marginal_neg_binomial_2_log|laplace_marginal_poisson_log|laplace_marginal_tol_bernoulli_logit|laplace_marginal_tol_neg_binomial_2_log|laplace_marginal_tol_poisson_log|lkj_corr|lkj_corr_cholesky|logistic|loglogistic|lognormal|multi_gp|multi_gp_cholesky|multi_normal|multi_normal_cholesky|multi_normal_prec|multi_student_t|multi_student_t_cholesky|multinomial|multinomial_logit|neg_binomial|neg_binomial_2|neg_binomial_2_log|neg_binomial_2_log_glm|normal|normal_id_glm|ordered_logistic|ordered_logistic_glm|ordered_probit|pareto|pareto_type_2|poisson|poisson_log|poisson_log_glm|rayleigh|scaled_inv_chi_square|skew_double_exponential|skew_normal|std_normal|student_t|uniform|von_mises|weibull|wiener|wishart|wishart_cholesky|yule_simon)\\b'
        }
      ]
    },
    docblock: {
    ...
    keywords: {
      patterns: [
        {match: '\\b(for|in|while|if|else)\\b', name: 'keyword.control.stan'},
        {
          captures: {
            1: {name: 'keyword.other.transform.stan'},
            2: {name: 'punctuation.operator.equal.stan'}
          },
          match: '\\b(lower|upper|offset|multiplier)\\s*(=)'
        },
        {match: '\\breturn\\b', name: 'keyword.other.return.stan'},
        {
          ...
          match: '\\b(target|jacobian)\\s*([+][=])'
        },
        {
          match: '\\b(print|reject|target|fatal_error)\\b',
      ...
      patterns: [
        {
          match:
            '(?x)\n(\n[0-9]+\\.[0-9]*([eE][+-]?[0-9]+)?\n|\n\\.[0-9]+([eE][+-]?[0-9]+)?\n|\n[0-9]+[eE][+-]?[0-9]+i\n)i',
          name: 'constant.numeric.complex.stan'
        },
        {
          match:
            '(?x)\n(\n[0-9]+\\.[0-9]*([eE][+-]?[0-9]+)?\n|\n\\.[0-9]+([eE][+-]?[0-9]+)?\n|\n[0-9]+[eE][+-]?[0-9]+\n)',
    ...
    operators: {
      patterns: [
        ...
        {match: '~', name: 'keyword.operator.sampling.stan'},
    ...
    types: {
      patterns: [
        {
          match:
            '\\b(int|real|data|complex|array|tuple|vector|simplex|unit_vector|sum_to_zero_vector|sum_to_zero_matrix|ordered|positive_ordered|row_vector|matrix|complex_vector|complex_matrix|complex_row_vector|corr_matrix|cov_matrix|cholesky_factor_cov|cholesky_factor_corr|column_stochastic_matrix|row_stochastic_matrix|void)\\b',

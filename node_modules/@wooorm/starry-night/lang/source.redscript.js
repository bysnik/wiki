  ...
  repository: {
    attributes: {
      patterns: [
        {
          begin:
            '((@)(?:(?:wrap|add|replace)Method|replaceGlobal|addField|runtimeProperty))(\\()',
          beginCaptures: {
            1: {name: 'storage.modifier.attribute.redscript'},
            2: {name: 'punctuation.definition.attribute.redscript'},
            3: {name: 'punctuation.definition.arguments.begin.redscript'}
          },
          end: '(?!\\G)\\)',
          endCaptures: {
            0: {name: 'punctuation.definition.arguments.end.redscript'}
          },
    ...
    'builtin-functions': {
      patterns: [
        {
          match:
            '(?<=\\.)(?:DetectScriptableCycles|GetClassName|IsA|IsExactlyA|ToString)(?=\\s*[({])\\b',
    ...
    'builtin-global-functions': {
      patterns: [
        {
          match:
            '\\b(Equals|NotEquals|IsDefined|To(String|Variant)|EnumInt|IntEnum|Array(Size|Resize|Push|Pop|Clear|Find(First|Last)|Contains|Count|Insert|Remove|Grow|Erase|Last))(?=\\s*\\()',
          name: 'support.function.redscript'
        }
      ]
    },
    'builtin-properties': {
      patterns: [
        {match: '(?<=\\.)(?:value)\\b', name: 'support.variable.redscript'}
      ]
    },
    'builtin-types': {
      patterns: [
        ...
        {match: '\\bAny\\b', name: 'support.type.any.redscript'}
      ],
      repository: {
        'builtin-class-type': {
          match:
            '\\b(IScriptable|Vector(2|3|4)|Void|Bool|String|CName|ResRef|TweakDBID|Int(32|64)|Uint32|Float|Double)\\b',
          ...
          patterns: [
            {
              ...
              beginCaptures: {
                1: {name: 'keyword.other.reference-specifier.redscript'},
                2: {name: 'punctuation.definition.arguments.begin.redscript'}
              },
              end: '>',
              endCaptures: {
                0: {name: 'punctuation.definition.arguments.end.redscript'}
    ...
    'code-block': {
      begin: '\\{',
      beginCaptures: {0: {name: 'punctuation.section.scope.begin.redscript'}},
      end: '\\}',
      endCaptures: {0: {name: 'punctuation.section.scope.end.redscript'}},
      patterns: [{include: '$self'}]
    },
    comments: {
      patterns: [
        {
          captures: {1: {name: 'punctuation.definition.comment.redscript'}},
          match: '\\A^(#!).*$\\n?',
        ...
        },
        {
          begin: '/\\*\\*(?!/)',
          beginCaptures: {
            0: {name: 'punctuation.definition.comment.begin.redscript'}
          },
          end: '\\*/',
          endCaptures: {
            0: {name: 'punctuation.definition.comment.end.redscript'}
          },
        ...
        },
        {
          begin: '(^[ \\t]+)?(?=//)',
          beginCaptures: {
            1: {name: 'punctuation.whitespace.comment.leading.redscript'}
          },
          end: '(?!\\G)',
          patterns: [
            {
              begin: '///',
              beginCaptures: {
                0: {name: 'punctuation.definition.comment.redscript'}
              },
              end: '^',
      ...
      patterns: [
        {
          ...
          beginCaptures: {
            0: {name: 'meta.preprocessor.conditional.redscript'},
            1: {name: 'punctuation.definition.preprocessor.redscript'},
            2: {name: 'keyword.control.preprocessor.conditional.redscript'},
            3: {name: 'constant.language.boolean.redscript'}
          },
        ...
        },
        {
          ...
          patterns: [
            {match: '(&&|\\|\\|)', name: 'keyword.operator.logical.redscript'},
            {
            ...
            {
              captures: {
                1: {name: 'keyword.other.condition.redscript'},
                2: {name: 'punctuation.definition.parameters.begin.redscript'},
                3: {name: 'support.constant.platform.architecture.redscript'},
                4: {name: 'punctuation.definition.parameters.end.redscript'}
              },
              match:
            ...
            },
            {
              captures: {
                1: {name: 'keyword.other.condition.redscript'},
                2: {name: 'punctuation.definition.parameters.begin.redscript'},
                3: {name: 'support.constant.platform.os.redscript'},
                4: {name: 'punctuation.definition.parameters.end.redscript'}
              },
              match:
            ...
            },
            {
              captures: {
                1: {name: 'keyword.other.condition.redscript'},
                2: {name: 'punctuation.definition.parameters.begin.redscript'},
                3: {name: 'entity.name.type.module.redscript'},
                4: {name: 'punctuation.definition.parameters.end.redscript'}
              },
              match:
            ...
            },
            {
              ...
              endCaptures: {
                1: {name: 'punctuation.definition.parameters.end.redscript'}
              },
              patterns: [
                {
            ...
            },
            {
              ...
              patterns: [
                {match: '>=|<', name: 'keyword.operator.comparison.redscript'},
                {
                  match: '\\b[0-9]+(?:\\.[0-9]+)*\\b',
        ...
        },
        {
          captures: {
            1: {name: 'punctuation.definition.preprocessor.redscript'},
            2: {name: 'keyword.control.preprocessor.sourcelocation.redscript'},
            4: {name: 'punctuation.definition.parameters.begin.redscript'},
            5: {
              patterns: [
                {
                  begin: '(file)\\s*(:)\\s*(?=")',
                  beginCaptures: {
                    1: {name: 'support.variable.parameter.redscript'},
                    2: {name: 'punctuation.separator.key-value.redscript'}
                  },
                  end: '(?!\\G)',
                ...
                },
                {
                  captures: {
                    1: {name: 'support.variable.parameter.redscript'},
                    2: {name: 'punctuation.separator.key-value.redscript'},
                    3: {name: 'constant.numeric.integer.redscript'}
                  },
                  match: '(line)\\s*(:)\\s*([0-9]+)'
                },
                {
            ...
            6: {name: 'punctuation.definition.parameters.begin.redscript'},
            7: {
              patterns: [
                {
                  match: '\\S+',
      ...
      patterns: [
        {
          begin: '\\bnew\\s',
          beginCaptures: {
            0: {name: 'keyword.other.declarataion-specifier.redscript'},
            1: {name: 'entity.name.class.redscript'}
          },
          end: '(?!\\G)(\\))',
          endCaptures: {
            1: {name: 'punctuation.definition.arguments.end.redscript'}
          },
          ...
          patterns: [
            {
              ...
              beginCaptures: {
                1: {name: 'entity.name.class.redscript'},
                4: {name: 'punctuation.definition.arguments.begin.redscript'}
              },
              end: '(?!\\G)|',
      ...
      repository: {
        'available-types': {
          patterns: [
            ...
            {match: '\\binout\\b', name: 'storage.modifier.redscript'},
            {
              captures: {1: {name: 'keyword.operator.type.function.redscript'}},
              match: '(?<![/=\\-+!*%<>&|\\^~.])(->)(?![/=\\-+!*%<>&|\\^~.])'
            },
            {
              captures: {
                1: {name: 'keyword.operator.type.composition.redscript'}
              },
              match: '(?<![/=\\-+!*%<>&|\\^~.])(&)(?![/=\\-+!*%<>&|\\^~.])'
            },
            {match: '[?!]', name: 'keyword.operator.type.optional.redscript'},
            {
              match: '\\.\\.\\.',
          ...
          repository: {
            'collection-type': {
              begin: '\\[',
              beginCaptures: {
                0: {name: 'punctuation.section.collection-type.begin.redscript'}
              },
              end: '\\]|(?=[>){}])',
              endCaptures: {
                0: {name: 'punctuation.section.collection-type.end.redscript'}
              },
              patterns: [
                {include: '#available-types'},
                {
                  begin: ':',
                  beginCaptures: {
                    0: {name: 'punctuation.separator.key-value.redscript'}
                  },
                  end: '(?=\\]|[>){}])',
                  patterns: [
                    {
            ...
            'tuple-type': {
              begin: '\\(',
              beginCaptures: {
                0: {name: 'punctuation.section.tuple-type.begin.redscript'}
              },
              end: '\\)|(?=[>\\]{}])',
              endCaptures: {
                0: {name: 'punctuation.section.tuple-type.end.redscript'}
              },
        ...
        extension: {
          ...
          beginCaptures: {
            1: {name: 'storage.type.$1.redscript'},
            2: {
              name: 'entity.name.type.redscript',
              patterns: [{include: '#available-types'}]
            },
            3: {name: 'punctuation.definition.identifier.redscript'},
            4: {name: 'punctuation.definition.identifier.redscript'}
          },
          end: '(?<=\\})',
          ...
          patterns: [
            ...
            {include: '#inheritance-clause'},
            {
              begin: '\\{',
              beginCaptures: {
                0: {name: 'punctuation.definition.type.begin.redscript'}
              },
              end: '\\}',
              endCaptures: {
                0: {name: 'punctuation.definition.type.end.redscript'}
              },
        ...
        function: {
          ...
          beginCaptures: {
            1: {name: 'storage.type.function.redscript'},
          ...
          patterns: [
            ...
            {include: '#generic-where-clause'},
            {
              begin: '(\\{)',
              beginCaptures: {
                1: {name: 'punctuation.section.function.begin.redscript'}
              },
              end: '(\\})',
              endCaptures: {
                1: {name: 'punctuation.section.function.end.redscript'}
              },
        ...
        'function-result': {
          begin: '(?<![/=\\-+!*%<>&|\\^~.])(->)(?![/=\\-+!*%<>&|\\^~.])\\s*',
          beginCaptures: {
            1: {name: 'keyword.operator.function-result.redscript'}
          },
          end: '(?!\\G)(?=\\{|;)|$',
        ...
        'generic-parameter-clause': {
          ...
          patterns: [
            ...
            {
              captures: {
                1: {name: 'variable.language.generic-parameter.redscript'}
              },
              match: '\\b((?!\\d)\\w[\\w\\d]*)\\b'
            },
            {
        ...
        'generic-where-clause': {
          begin: '\\b(where)\\b\\s*',
          beginCaptures: {
            1: {name: 'keyword.other.generic-constraint-introducer.redscript'}
          },
          end: '(?!\\G)$|(?=[>{};\\n]|//|/\\*)',
        ...
        import: {
          begin: '(?<!\\.)\\b(import)\\s+',
          beginCaptures: {1: {name: 'keyword.control.import.redscript'}},
          end: '(;)|$\\n?|(?=//|/\\*)',
          endCaptures: {
            1: {name: 'punctuation.terminator.statement.redscript'}
          },
          ...
          patterns: [
            {
              ...
              beginCaptures: {1: {name: 'storage.modifier.redscript'}},
              end: '(?=;|$|//|/\\*)',
              patterns: [
                {
                  captures: {
                    1: {name: 'punctuation.definition.identifier.redscript'},
                    2: {name: 'punctuation.definition.identifier.redscript'}
                  },
                  match:
                    '(?x)\n\t\t\t\t\t\t\t\t\t\t(?<=\\G|\\.)\n\t\t\t\t\t\t\t\t\t\t(?<q>`?)[\\p{L}_][\\p{L}_\\p{N}\\p{M}]*(\\k<q>)\n\t\t\t\t\t\t\t\t\t',
                  name: 'entity.name.type.redscript'
                ...
                {match: '\\.', name: 'punctuation.separator.import.redscript'},
                {
                  begin: '(?!\\s*(;|$|//|/\\*))',
                  end: '(?=\\s*(;|$|//|/\\*))',
                  name: 'invalid.illegal.character-not-allowed-here.redscript'
        ...
        'inheritance-clause': {
          ...
          beginCaptures: {
            1: {name: 'invalid.illegal.empty-inheritance-clause.redscript'},
            2: {name: 'punctuation.separator.inheritance-clause.redscript'}
          },
          end: '(?!\\G)$|(?=[={}])',
        ...
        operator: {
          ...
          beginCaptures: {
            1: {name: 'storage.modifier.redscript'},
            2: {name: 'storage.type.function.operator.redscript'},
            3: {name: 'entity.name.function.operator.redscript'},
            4: {
              patterns: [
                {
                  match: '\\.',
          ...
          repository: {
            redscript2: {
              begin: '\\G(\\{)',
              beginCaptures: {
                1: {name: 'punctuation.definition.operator.begin.redscript'}
              },
              end: '(\\})',
              endCaptures: {
                1: {name: 'punctuation.definition.operator.end.redscript'}
              },
              patterns: [
                {include: '#comments'},
                {
                  captures: {
                    1: {name: 'storage.modifier.redscript'},
                    2: {name: 'keyword.other.operator.associativity.redscript'}
                  },
                ...
                },
                {
                  captures: {
                    1: {name: 'storage.modifier.redscript'},
                    2: {name: 'constant.numeric.integer.redscript'}
                  },
                  match: '\\b(precedence)\\s+([0-9]+)\\b'
                },
                {
                  captures: {1: {name: 'storage.modifier.redscript'}},
        ...
        'parameter-clause': {
          begin: '(\\()',
          beginCaptures: {
            1: {name: 'punctuation.definition.parameters.begin.redscript'}
          },
          end: '(\\))(?:\\s*(async)\\b)?',
          endCaptures: {
            1: {name: 'punctuation.definition.parameters.end.redscript'},
            2: {name: 'keyword.control.async.redscript'}
          },
        ...
        'parameter-list': {
          patterns: [
            {
              captures: {
                1: {name: 'keyword.redscript'},
                2: {name: 'punctuation.definition.identifier.redscript'},
                3: {name: 'punctuation.definition.identifier.redscript'},
                4: {name: 'variable.parameter.function.redscript'},
                5: {name: 'punctuation.definition.identifier.redscript'},
                6: {name: 'punctuation.definition.identifier.redscript'}
              },
              match:
            ...
            {
              captures: {
                1: {name: 'variable.parameter.function.redscript'},
                3: {name: 'punctuation.definition.identifier.redscript'},
                4: {name: 'punctuation.definition.identifier.redscript'}
              },
              match:
            ...
            },
            {
              ...
              patterns: [
                ...
                },
                {
                  begin: '=',
                  beginCaptures: {
                    0: {name: 'keyword.operator.assignment.redscript'}
                  },
                  end: '(?=[,)])',
        ...
        precedencegroup: {
          ...
          beginCaptures: {
            1: {name: 'storage.type.precedencegroup.redscript'},
            2: {name: 'entity.name.type.precedencegroup.redscript'},
            3: {name: 'punctuation.definition.identifier.redscript'},
            4: {name: 'punctuation.definition.identifier.redscript'}
          },
          end: '(?!\\G)',
          ...
          patterns: [
            {
              ...
              patterns: [
                ...
                },
                {
                  captures: {
                    1: {name: 'storage.modifier.redscript'},
                    2: {name: 'constant.language.boolean.redscript'}
                  },
        ...
        protocol: {
          ...
          beginCaptures: {
            1: {name: 'storage.type.$1.redscript'},
            2: {name: 'entity.name.type.$1.redscript'},
            3: {name: 'punctuation.definition.identifier.redscript'},
            4: {name: 'punctuation.definition.identifier.redscript'}
          },
          end: '(?<=\\})',
          ...
          repository: {
            'associated-type': {
              ...
              beginCaptures: {
                1: {name: 'keyword.other.declaration-specifier.redscript'},
                2: {name: 'variable.language.associatedtype.redscript'},
                3: {name: 'punctuation.definition.identifier.redscript'},
                4: {name: 'punctuation.definition.identifier.redscript'}
              },
              end: '(?!\\G)$|(?=[;}]|$)',
            ...
            'protocol-initializer': {
              ...
              patterns: [
                ...
                {include: '#generic-where-clause'},
                {
                  begin: '\\{',
                  beginCaptures: {
                    0: {name: 'punctuation.section.function.begin.redscript'}
                  },
                  end: '\\}',
                  endCaptures: {
                    0: {name: 'punctuation.section.function.end.redscript'}
                  },
        ...
        type: {
          patterns: [
            {
              begin:
                '\\b(class(?!\\s+(?:func|let)\\b)|struct|actor)\\s+((?<q>`?)[\\p{L}_][\\p{L}_\\p{N}\\p{M}]*(\\k<q>))',
              beginCaptures: {
                1: {name: 'storage.type.$1.redscript'},
                2: {name: 'entity.name.$1.redscript'},
                3: {name: 'punctuation.definition.identifier.redscript'},
                4: {name: 'punctuation.definition.identifier.redscript'}
              },
              end: '(?<=\\})',
        ...
        'type-enum': {
          ...
          repository: {
            'associated-values': {
              begin: '\\G\\(',
              beginCaptures: {
                0: {name: 'punctuation.definition.parameters.begin.redscript'}
              },
              end: '\\)',
              endCaptures: {
                0: {name: 'punctuation.definition.parameters.end.redscript'}
              },
              patterns: [
                {include: '#comments'},
                {
                  ...
                  beginCaptures: {
                    1: {name: 'entity.name.function.redscript'},
                    2: {
                      name: 'invalid.illegal.distinct-labels-not-allowed.redscript'
                    },
                    5: {name: 'variable.parameter.function.redscript'},
                    7: {name: 'punctuation.separator.argument-label.redscript'}
                  },
                  end: '(?=[,)\\]])',
                  patterns: [{include: '#available-types'}]
                },
                {
                  ...
                  beginCaptures: {
                    1: {name: 'entity.name.function.redscript'},
                    2: {name: 'variable.parameter.function.redscript'},
                    4: {name: 'punctuation.separator.argument-label.redscript'}
                  },
                  end: '(?=[,)\\]])',
                  patterns: [{include: '#available-types'}]
                },
            ...
            'enum-case': {
              ...
              beginCaptures: {1: {name: 'constant.other.redscript'}},
              end: '(?<=\\))|(?![=(])',
              patterns: [
                {include: '#comments'},
            ...
            'enum-case-clause': {
              begin: '\\b(case)\\b\\s*',
              beginCaptures: {1: {name: 'storage.type.enum.case.redscript'}},
              end: '(?=[;}])|(?!\\G)(?!//|/\\*)(?=[^\\s,])',
              patterns: [
                {include: '#comments'},
                {include: '#enum-case'},
            ...
            'raw-value-assignment': {
              begin: '(=)\\s*',
              beginCaptures: {
                1: {name: 'keyword.operator.assignment.redscript'}
              },
              end: '(?!\\G)',
        ...
        typealias: {
          ...
          beginCaptures: {
            1: {name: 'keyword.other.declaration-specifier.redscript'},
            2: {name: 'entity.name.type.typealias.redscript'},
            3: {name: 'punctuation.definition.identifier.redscript'},
            4: {name: 'punctuation.definition.identifier.redscript'}
          },
          end: '(?!\\G)$|(?=;|//|/\\*|$)',
        ...
        'typealias-assignment': {
          begin: '(=)\\s*',
          beginCaptures: {1: {name: 'keyword.operator.assignment.redscript'}},
          end: '(?!\\G)$|(?=;|//|/\\*|$)',
          patterns: [{include: '#available-types'}, {include: '#constructor'}]
        },
    ...
    expressions: {
      patterns: [
        ...
        {match: '\\b_\\b', name: 'support.variable.discard-value.redscript'}
      ],
      repository: {
        'availability-condition': {
          begin: '\\B(#(?:un)?available)(\\()',
          beginCaptures: {
            1: {name: 'support.function.availability-condition.redscript'},
            2: {name: 'punctuation.definition.arguments.begin.redscript'}
          },
          end: '\\)',
          endCaptures: {
          ...
          patterns: [
            {
              captures: {
                1: {name: 'keyword.other.platform.os.redscript'},
                2: {name: 'constant.numeric.redscript'}
              },
              match:
            ...
            {
              captures: {
                1: {name: 'keyword.other.platform.all.redscript'},
                2: {
                  name: 'invalid.illegal.character-not-allowed-here.redscript'
                }
              },
        ...
        'compound-name': {
          captures: {
            1: {name: 'entity.name.function.compound-name.redscript'},
            2: {name: 'punctuation.definition.entity.redscript'},
            3: {name: 'punctuation.definition.entity.redscript'},
            4: {
              patterns: [
                {
                  captures: {
                    1: {name: 'punctuation.definition.entity.redscript'},
                    2: {name: 'punctuation.definition.entity.redscript'}
                  },
                  match:
        ...
        'function-call-expression': {
          patterns: [
            ...
            },
            {
              ...
              beginCaptures: {
                1: {name: 'punctuation.definition.arguments.begin.redscript'}
              },
              end: '\\)',
              endCaptures: {
                0: {name: 'punctuation.definition.arguments.end.redscript'}
        ...
        'member-reference': {
          patterns: [
            {
              captures: {
                1: {name: 'variable.other.redscript'},
                2: {name: 'punctuation.definition.identifier.redscript'},
                3: {name: 'punctuation.definition.identifier.redscript'}
              },
              match: '(?<=\\.)((?<q>`?)[\\p{L}_][\\p{L}_\\p{N}\\p{M}]*(\\k<q>))'
        ...
        'parenthesized-expression': {
          begin: '\\(',
          beginCaptures: {
            0: {name: 'punctuation.section.tuple.begin.redscript'}
          },
          end: '(\\))\\s*((?:\\b(?:async|throws|rethrows)\\s)*)',
          endCaptures: {
            1: {name: 'punctuation.section.tuple.end.redscript'},
            2: {
              patterns: [
                {
                  match: '\\brethrows\\b',
      ...
      patterns: [
        {
          begin: '\\bCast(\\<)',
          beginCaptures: {
            0: {name: 'support.function.redscript'},
            1: {name: 'punctuation.definition.arguments.begin.redscript'}
          },
          end: '(?!\\G)\\>',
          endCaptures: {
    ...
    keywords: {
      patterns: [
        {
          match:
            '(?<!\\.)\\b(?:if|else|guard|where|switch|case|default|fallthrough)\\b',
        ...
        {
          captures: {
            1: {name: 'keyword.control.loop.redscript'},
            2: {name: 'punctuation.whitespace.trailing.repeat.redscript'}
          },
          match: '(?<!\\.)\\b(repeat)\\b(\\s*)'
        },
        {match: '(?<!\\.)\\bdefer\\b', name: 'keyword.control.defer.redscript'},
        {
          captures: {
            1: {name: 'invalid.illegal.try-must-precede-await.redscript'},
            2: {name: 'keyword.control.await.redscript'}
          },
        ...
        {
          captures: {
            1: {name: 'keyword.control.exception.redscript'},
            2: {name: 'punctuation.whitespace.trailing.do.redscript'}
          },
          match: '(?<!\\.)\\b(do)\\b(\\s*)'
        },
        {
        ...
        {
          match:
            '(?<!\\.)\\b(?:static|cb|final|abstract|native|const|persistent|browsable|replicated|inline|edit)\\b',
        ...
        {
          match:
            '(?<!\\.)\\b(?:fileprivate|private|internal|public|protected|open)\\b',
          name: 'keyword.other.declaration-specifier.accessibility.redscript'
        },
        {
          match:
            '(?<!\\.)\\bunowned\\((?:safe|unsafe)\\)|(?<!\\.)\\b(?:weak|unowned)\\b',
          name: 'keyword.other.capture-specifier.redscript'
        },
        {
          captures: {
            1: {name: 'keyword.operator.type.redscript'},
            2: {name: 'keyword.operator.type.metatype.redscript'}
          },
    ...
    literals: {
      patterns: [
        ...
        {include: '#numeric'},
        {include: '#string'},
        {match: '\\bnull\\b', name: 'constant.language.nil.redscript'},
        {match: '\\B#keyPath\\b', name: 'support.function.key-path.redscript'},
        {
          begin: '\\B(#selector)(\\()(?:\\s*(getter|setter)\\s*(:))?',
          beginCaptures: {
            1: {name: 'support.function.selector-reference.redscript'},
            2: {name: 'punctuation.definition.arguments.begin.redscript'},
            3: {name: 'support.variable.parameter.redscript'},
            4: {name: 'punctuation.separator.argument-label.redscript'}
          },
          end: '\\)',
          endCaptures: {
          ...
          patterns: [
            {
              begin: '"""',
              beginCaptures: {
                0: {name: 'punctuation.definition.string.begin.redscript'}
              },
              end: '"""(#*)',
              endCaptures: {
                0: {name: 'punctuation.definition.string.end.redscript'},
                1: {name: 'invalid.illegal.extra-closing-delimiter.redscript'}
              },
            ...
            },
            {
              begin: '(##+)"',
              beginCaptures: {
                0: {name: 'punctuation.definition.string.begin.raw.redscript'}
              },
              end: '"\\1(#*)',
              endCaptures: {
                0: {name: 'punctuation.definition.string.end.raw.redscript'},
                1: {name: 'invalid.illegal.extra-closing-delimiter.redscript'}
              },
            ...
            'raw-string-guts': {
              patterns: [
                ...
                },
                {
                  begin: '\\\\#\\(',
                  beginCaptures: {
                    0: {name: 'punctuation.section.embedded.begin.redscript'}
                  },
                  contentName: 'source.redscript',
                  end: '(\\))',
                  endCaptures: {
                    0: {name: 'punctuation.section.embedded.end.redscript'},
                    1: {name: 'source.redscript'}
                  },
    ...
    operators: {
      patterns: [
          ...
          patterns: [
            {
              begin: '\\b(as)\\b\\s+',
              beginCaptures: {
                1: {name: 'keyword.operator.type-casting.redscript'}
              },
              end: '(?!\\G)',
        ...
        {match: ':', name: 'keyword.operator.ternary.redscript'}
      ]
    },
    root: {
      patterns: [

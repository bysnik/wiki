...
const grammar = {
  ...
  patterns: [
    ...
    {include: '#scopedExternalContentCommand'},
  ...
  repository: {
    ...
    conditionalOperators: {
      match:
        '\\b(?i:NOT|AND|OR|COMMAND|POLICY|TARGET|TEST|DEFINED|IN_LIST|EXISTS|IS_ABSOLUTE|IS_DIRECTORY|IS_SYMLINK|IS_NEWER_THAN|MATCHES|LESS|GREATER|EQUAL|LESS_EQUAL|GREATER_EQUAL|STRLESS|STRGREATER|STREQUAL|STRLESS_EQUAL|STRGREATER_EQUAL|VERSION_LESS|VERSION_GREATER|VERSION_EQUAL|VERSION_LESS_EQUAL|VERSION_GREATER_EQUAL|PATH_EQUAL)\\b',
      name: 'keyword.operator.cmake'
    },
    deprecatedKeywords: {match: '(?!x)x', name: 'invalid.deprecated.cmake'},
    envVariableReference: {
      match: '\\$ENV\\{\\w+\\}',
      name: 'variable.other.env.cmake'
    },
    escape: {match: '\\\\(.|$)', name: 'constant.character.escape.cmake'},
    generatorExpression: {
      begin: '\\$<',
      beginCaptures: {
    ...
    nestedParens: {
      ...
      patterns: [{include: '#nestedParens'}, {include: '#commonArgPatterns'}]
    },
    nestedParensIf: {
      begin: '\\(',
      end: '\\)',
    ...
    operators: {
      match:
        '\\b(?i:ABSOLUTE|AND|COMMAND|DEFINED|DIRECTORY|EQUAL|EXISTS|GREATER|GREATER_EQUAL|IN_LIST|IS_ABSOLUTE|IS_DIRECTORY|IS_NEWER_THAN|IS_SYMLINK|LAST_EXT|LESS|LESS_EQUAL|MATCHES|NAME|NAME_WE|NAME_WLE|NOT|NOTFOUND|OR|PATH|PATHS|POLICY|PROGRAM|REALPATH|STREQUAL|STRGREATER|STRGREATER_EQUAL|STRING|STRLESS|STRLESS_EQUAL|TARGET|TEST|VERSION_EQUAL|VERSION_GREATER|VERSION_GREATER_EQUAL|VERSION_LESS)\\b',
      name: 'keyword.operator.cmake'
    },
    properties: {
      match:
        '\\b(?i:ADVANCED|HELPSTRING|MODIFIED|STRINGS|TYPE|VALUE|ABSTRACT|COMPILE_DEFINITIONS|COMPILE_DEFINITIONS_&lt;CONFIG&gt;|COMPILE_FLAGS|EXTERNAL_OBJECT|Fortran_FORMAT|GENERATED|HEADER_FILE_ONLY|KEEP_EXTENSION|LABELS|LANGUAGE|LOCATION|MACOSX_PACKAGE_LOCATION|OBJECT_DEPENDS|OBJECT_OUTPUTS|SYMBOLIC|WRAP_EXCLUDE|DEPENDS|EXCLUDE_FROM_ALL|NAME|PASS_REGULAR_EXPRESSION|RUN_SERIAL|RUN_TESTS|TIMEOUT|ADDITIONAL_MAKE_CLEAN_FILES|CACHE_VARIABLES|CLEAN_NO_CUSTOM|COMPILE_DEFINITIONS_\\w+|DEFINITIONS|IMPLICIT_DEPENDS_INCLUDE_TRANSFORM|INCLUDE_DIRECTORIES|INCLUDE_REGULAR_EXPRESSION|INTERPROCEDURAL_OPTIMIZATION|INTERPROCEDURAL_OPTIMIZATION_\\w+|LINK_DIRECTORIES|LISTFILE_STACK|MACROS|PARENT_DIRECTORY|RULE_LAUNCH_COMPILE|RULE_LAUNCH_CUSTOM|RULE_LAUNCH_LINK|TEST_INCLUDE_FILE|VARIABLES|VS_GLOBAL_SECTION_POST_\\w+|VS_GLOBAL_SECTION_PRE_\\w+|ALLOW_DUPLICATE_CUSTOM_TARGETS|DEBUG_CONFIGURATIONS|DISABLED_FEATURES|ENABLED_FEATURES|ENABLED_LANGUAGES|FIND_LIBRARY_USE_LIB64_PATHS|FIND_LIBRARY_USE_OPENBSD_VERSIONING|GLOBAL_DEPENDS_DEBUG_MODE|GLOBAL_DEPENDS_NO_CYCLES|IN_TRY_COMPILE|PACKAGES_FOUND|PACKAGES_NOT_FOUND|PREDEFINED_TARGETS_FOLDER|REPORT_UNDEFINED_PROPERTIES|RULE_MESSAGES|TARGET_ARCHIVES_MAY_BE_SHARED_LIBS|TARGET_SUPPORTS_SHARED_LIBS|USE_FOLDERS|__CMAKE_DELETE_CACHE_CHANGE_VARS_|\\w+_(OUTPUT_NAME|POSTFIX)|ARCHIVE_OUTPUT_(DIRECTORY(_\\w+)?|NAME(_\\w+)?)|AUTOMOC(_MOC_OPTIONS)?|BUILD_WITH_INSTALL_RPATH|BUNDLE(_EXTENSION)?|COMPATIBLE_INTERFACE_BOOL|COMPATIBLE_INTERFACE_STRING|COMPILE_(DEFINITIONS(_\\w+)?|FLAGS)|DEBUG_POSTFIX|DEFINE_SYMBOL|ENABLE_EXPORTS|EchoString|FOLDER|FRAMEWORK|Fortran_(FORMAT|MODULE_DIRECTORY)|GENERATOR_FILE_NAME|GNUtoMS|HAS_CXX|IMPORTED|IMPORTED_(CONFIGURATIONS|IMPLIB(_\\w+)?|LINK_DEPENDENT_LIBRARIES(_\\w+)?|LINK_INTERFACE_LANGUAGES(_\\w+)?|LINK_INTERFACE_LIBRARIES(_\\w+)?|LINK_INTERFACE_MULTIPLICITY(_\\w+)?|LOCATION(_\\w+)?|NO_SONAME(_\\w+)?|SONAME(_\\w+)?)|IMPORT_PREFIX|IMPORT_SUFFIX|INSTALL_NAME_DIR|INSTALL_RPATH|INSTALL_RPATH_USE_LINK_PATH|INTERFACE|INTERFACE_COMPILE_DEFINITIONS|INTERFACE_INCLUDE_DIRECTORIES|LIBRARY_OUTPUT_DIRECTORY(_\\w+)?|LIBRARY_OUTPUT_NAME(_\\w+)?|LINKER_LANGUAGE|LINK_DEPENDS|LINK_FLAGS(_\\w+)?|LINK_INTERFACE_LIBRARIES(_\\w+)?|LINK_INTERFACE_MULTIPLICITY(_\\w+)?|LINK_LIBRARIES|LINK_SEARCH_END_STATIC|LINK_SEARCH_START_STATIC|LOCATION(_\\w+)?|MACOSX_BUNDLE|MACOSX_BUNDLE_INFO_PLIST|MACOSX_FRAMEWORK_INFO_PLIST|MAP_IMPORTED_CONFIG_\\w+|NO_SONAME|OSX_ARCHITECTURES(_\\w+)?|OUTPUT_NAME(_\\w+)?|PDB_NAME(_\\w+)?|POST_INSTALL_SCRIPT|PREFIX|PRE_INSTALL_SCRIPT|PRIVATE|PRIVATE_HEADER|PROJECT_LABEL|PUBLIC|PUBLIC_HEADER|RESOURCE|RULE_LAUNCH_(COMPILE|CUSTOM|LINK)|RUNTIME_OUTPUT_(DIRECTORY(_\\w+)?|NAME(_\\w+)?)|SKIP_BUILD_RPATH|SOURCES|SOVERSION|STATIC_LIBRARY_FLAGS(_\\w+)?|SUFFIX|VERSION|VS_DOTNET_REFERENCES|VS_GLOBAL_(\\w+|KEYWORD|PROJECT_TYPES)|VS_KEYWORD|VS_SCC_(AUXPATH|LOCALPATH|PROJECTNAME|PROVIDER)|VS_WINRT_EXTENSIONS|VS_WINRT_REFERENCES|WIN32_EXECUTABLE|XCODE_ATTRIBUTE_\\w+)\\b',
    ...
    scopedExternalContentCommand: {
      begin:
        '\\b(?i:(FetchContent_Declare|FetchContent_MakeAvailable|FetchContent_Populate|FetchContent_GetProperties|FetchContent_SetPopulated|ExternalProject_Add|ExternalProject_Add_Step|ExternalProject_Add_StepTargets|ExternalProject_Add_StepDependencies|ExternalProject_Get_Property))\\b\\s*(\\()',
      beginCaptures: {
    ...
    scopedFindPackageHandleStdArgsCommand: {
      begin:
        '\\b(?i:(find_package_handle_standard_args|find_package_check_version))\\b\\s*(\\()',
      beginCaptures: {
        1: {name: 'support.function.cmake'},
        2: {name: 'punctuation.section.arguments.begin.cmake'}
      },
      ...
      patterns: [
        ...
        {
          match:
            '\\b(?i:REQUIRED_VARS|VERSION_VAR|HANDLE_VERSION_RANGE|HANDLE_COMPONENTS|CONFIG_MODE|NAME_MISMATCHED|REASON_FAILURE_MESSAGE|FAIL_MESSAGE|FOUND_VAR|DEFAULT_MSG|RESULT_MESSAGE_VARIABLE)\\b',
          name: 'keyword.other.cmake'
        }
      ]
    },
    ...
    scopedListCommand: {
      ...
      patterns: [
        ...
        {
          match:
            '\\b(?i:LENGTH|GET|APPEND|FILTER|FIND|INSERT|JOIN|POP_BACK|POP_FRONT|PREPEND|REMOVE_ITEM|REMOVE_AT|REMOVE_DUPLICATES|REVERSE|SORT|SUBLIST|TRANSFORM|INCLUDE|EXCLUDE|REGEX|COMPARE|CASE|ORDER|ASCENDING|DESCENDING|GENEX_STRIP|STRIP|TOLOWER|TOUPPER|REPLACE|AT|FOR|NATURAL|OUTPUT_VARIABLE)\\b',
          name: 'keyword.other.cmake'
        }
      ]
    },
    scopedMessageCommand: {
      ...
      patterns: [
        ...
        {
          match:
            '\\b(?i:FATAL_ERROR|SEND_ERROR|WARNING|AUTHOR_WARNING|DEPRECATION|NOTICE|STATUS|VERBOSE|DEBUG|TRACE|CHECK_START|CHECK_PASS|CHECK_FAIL|CONFIGURE_LOG|APPEND)\\b',
          name: 'keyword.other.cmake'
        }
      ]
    },
    scopedProjectCommand: {
      ...
      patterns: [
        ...
        {
          match:
            '\\b(?i:VERSION|DESCRIPTION|HOMEPAGE_URL|LANGUAGES|COMPAT_VERSION|SPDX_LICENSE)\\b',
          name: 'keyword.other.cmake'
        },
        {
          match:
            '\\b(?:C|CXX|CSharp|CUDA|OBJC|OBJCXX|Fortran|HIP|ISPC|Swift|ASM|ASM_NASM|ASM_MARMASM|ASM_MASM|Java|NONE)\\b',
    ...
    scopedPropertyCommand: {
      begin:
        '\\b(?i:(set_property|get_property|define_property|set_source_files_properties|set_target_properties|get_target_property|set_tests_properties|get_test_property|set_directory_properties|get_directory_property))\\b\\s*(\\()',
      beginCaptures: {
        1: {name: 'support.function.cmake'},
        2: {name: 'punctuation.section.arguments.begin.cmake'}
      },
    ...
    scopedSetCommand: {
      ...
      patterns: [
        ...
        {
          match:
            '\\b(?i:CACHE|PARENT_SCOPE|FORCE|BOOL|STRING|FILEPATH|PATH|INTERNAL)\\b',
          name: 'keyword.other.cmake'
        }
      ]
    },
    ...
    variableReference: {
      ...
      patterns: [{include: '#knownVariables'}]
    }
  },

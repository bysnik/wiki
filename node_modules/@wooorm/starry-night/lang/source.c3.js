...
// <https://github.com/c3lang/vscode-c3>
// and licensed `mit`.
...
const grammar = {
  extensions: ['.c3'],
  names: ['c3'],
  patterns: [{include: '#top_level'}, {include: '#statements'}],
  repository: {
    ...
    block: {
      patterns: [
        {
          begin: '\\{',
          beginCaptures: {0: {name: 'punctuation.section.block.begin.c3'}},
          end: '\\}',
          endCaptures: {0: {name: 'punctuation.section.block.end.c3'}},
          name: 'meta.block.c3',
    ...
    block_comment: {
      begin: '/\\*',
      beginCaptures: {0: {name: 'punctuation.definition.comment.begin.c3'}},
      end: '\\*/',
      endCaptures: {0: {name: 'punctuation.definition.comment.end.c3'}},
      name: 'comment.block.c3',
      patterns: [{include: '#block_comment_body'}]
    },
    block_comment_body: {
      patterns: [
        {
    ...
    brackets: {
      patterns: [
        {
          begin: '\\[<?',
          beginCaptures: {0: {name: 'punctuation.section.brackets.begin.c3'}},
          end: '>?\\]',
          endCaptures: {0: {name: 'punctuation.section.brackets.end.c3'}},
      ...
      patterns: [
        {
          ...
          match:
            '(\\$\\$(?:\\b_*[A-Z][_A-Z0-9]*\\b))|(\\$\\$(?:\\b_*[a-z][_a-zA-Z0-9]*\\b))'
        }
      ]
    },
    bytes_literal: {
      patterns: [
        {
          ...
          endCaptures: {0: {name: 'punctuation.definition.string.end.c3'}},
          name: 'string.quoted.other.c3',
          patterns: [
            {match: '[\\sfA-Fa-f0-9]+', name: 'constant.numeric.integer.c3'}
          ]
        },
        {
          begin: '(b64)(["\'`])',
          ...
          name: 'string.quoted.other.c3',
          patterns: [
            {match: '[\\sA-Za-z0-9+/=]+', name: 'constant.numeric.integer.c3'}
          ]
        }
      ]
    },
    char_literal: {
      begin: "'",
      beginCaptures: {0: {name: 'punctuation.definition.string.begin.c3'}},
      end: "'",
      endCaptures: {0: {name: 'punctuation.definition.string.end.c3'}},
    ...
    constants: {
      patterns: [
        {match: '\\b(true|false|null)\\b', name: 'constant.language.c3'},
        {
    ...
    control_statements: {
      patterns: [
        {
          begin: '\\$for\\b',
          beginCaptures: {0: {name: 'keyword.control.ct.c3'}},
          end: ':',
          endCaptures: {0: {name: 'punctuation.separator.c3'}},
          patterns: [{include: '#statements'}]
        },
        {
          begin: '\\$foreach\\b',
          ...
          patterns: [
            ...
            {
              begin: ':',
              beginCaptures: {0: {name: 'keyword.operator.c3'}},
              end: ':',
              endCaptures: {0: {name: 'punctuation.separator.c3'}},
              patterns: [{include: '#expression'}]
            }
        ...
        {
          begin: '\\bfor\\b',
          beginCaptures: {0: {name: 'keyword.control.c3'}},
          end: '(?<=\\))',
          patterns: [
            {include: '#comments'},
            {
              ...
              endCaptures: {0: {name: 'punctuation.section.group.end.c3'}},
              patterns: [{include: '#statements'}]
            }
          ]
        },
    ...
    doc_comment: {
      ...
      patterns: [{include: '#doc_comment_body'}]
    },
    doc_comment_body: {
      patterns: [
        {
          ...
          patterns: [
            {
              ...
              match:
                '@param(?:\\s*\\[&?(?:in|out|inout)\\])?\\s*(?:([$#]?(?:\\b_*[a-z][_a-zA-Z0-9]*\\b))|(\\$(?:\\b_*[A-Z][_A-Z0-9]*[a-z][_a-zA-Z0-9]*\\b))|(\\.\\.\\.))'
            },
            {
          ...
          patterns: [
            {
              ...
              match:
                '^\\s*@param(?:\\s*\\[&?(?:in|out|inout)\\])?\\s*(?:([$#]?(?:\\b_*[a-z][_a-zA-Z0-9]*\\b))|(\\$(?:\\b_*[A-Z][_A-Z0-9]*[a-z][_a-zA-Z0-9]*\\b))|(\\.\\.\\.))'
            },
            {
    ...
    function: {
      ...
      patterns: [
        {
          begin: '\\b(fn|macro)\\b',
          beginCaptures: {1: {name: 'keyword.declaration.function.c3'}},
          end: '(?=\\()',
          name: 'meta.function.c3',
          patterns: [{include: '#comments'}, {include: '#function_header'}]
        },
        {
          begin: '\\(',
          beginCaptures: {0: {name: 'punctuation.section.group.begin.c3'}},
    ...
    function_call: {
      ...
      beginCaptures: {1: {name: 'entity.name.function.c3'}},
      end: '(?<=\\))',
      ...
      patterns: [
        {include: '#generic_args'},
        {
          ...
          patterns: [
            ...
            {
              begin:
                '([$#]?(?:\\b_*[a-z][_a-zA-Z0-9]*\\b)|\\$(?:\\b_*[A-Z][_A-Z0-9]*[a-z][_a-zA-Z0-9]*\\b))\\s*(:)(?!:)',
              beginCaptures: {
                1: {name: 'variable.parameter.c3'},
                2: {name: 'punctuation.separator.c3'}
              },
              end: '(?=\\))|([;,])',
              endCaptures: {1: {name: 'punctuation.separator.c3'}},
              patterns: [{include: '#expression'}]
            },
            {
              begin: '(?=\\S)',
    ...
    function_header: {
      patterns: [
        {include: '#type'},
        {match: '\\.', name: 'punctuation.accessor.c3'},
        {
          match: '@?(?:\\b_*[a-z][_a-zA-Z0-9]*\\b)',
    ...
    integer_literal: {
      match:
        '\\b(?:0[xX][a-fA-F0-9](?:_?[a-fA-F0-9])*|0[oO][0-7](_?[0-7])*|0[bB][0-1](_?[0-1])*|[0-9](?:_?[0-9])*)(?:[UuIi](?:8|16|32|64|128)|[Uu][Ll]{0,2}|[Ll]{1,2})?',
    ...
    keywords: {
      patterns: [
        ...
        {
          match:
            '\\$(?:case|else|endfor|endforeach|endif|endswitch|for|foreach|if|switch)\\b',
          name: 'keyword.control.ct.c3'
        },
        {
          match:
            '\\b(?:assert|asm|catch|inline|import|module|interface|try|var)\\b',
          name: 'keyword.other.c3'
        },
        {
          match:
            '\\b(?:break|case|continue|default|defer|do|else|for|foreach|foreach_r|if|nextcase|return|switch|while)\\b',
    ...
    leftover_at_ident: {
      patterns: [
        {
          captures: {0: {name: 'keyword.annotation.c3'}},
    ...
    line_comment: {match: '//.*$', name: 'comment.line.double-slash.c3'},
    literals: {
      patterns: [
    ...
    module_path: {
      patterns: [
        {include: '#path'},
        {
          captures: {1: {name: 'entity.name.scope-resolution.c3'}},
          match: '((?:\\b_*[a-z][_a-zA-Z0-9]*\\b))',
          name: 'meta.path.c3'
        }
      ]
    ...
    operators: {
      patterns: [
        {match: '=>', name: 'keyword.declaration.function.arrow.c3'},
        {
          match: '(?:[-%&*+/^|]|>>|<<|\\+\\+\\+)=',
          name: 'keyword.operator.assignment.augmented.c3'
        },
        {match: '<=|>=|==|<|>|!=', name: 'keyword.operator.comparison.c3'},
        {match: '\\.\\.\\.', name: 'keyword.operator.variadic.c3'},
        {match: '\\.\\.', name: 'keyword.operator.range.c3'},
        {match: '\\+\\+\\+?|--', name: 'keyword.operator.arithmetic.c3'},
        {
          match: '<<|>>|&&&?|\\|\\|\\|?',
          name: 'keyword.operator.arithmetic.c3'
        },
        {match: '[-%+/^|~]', name: 'keyword.operator.arithmetic.c3'},
        {match: '=', name: 'keyword.operator.assignment.c3'},
        {match: '\\?\\?\\??|\\?:|[!?]|[&*:]', name: 'keyword.operator.c3'}
      ]
    },
    parameters: {
      patterns: [
        ...
        {include: '#punctuation'},
        {match: '\\.\\.\\.', name: 'keyword.operator.variadic.c3'},
        {match: '&', name: 'keyword.operator.address.c3'},
        {
          begin: ';',
          beginCaptures: {0: {name: 'punctuation.separator.c3'}},
          end: '(?=\\))',
          patterns: [
            {include: '#comments'},
            {
        ...
        {
          begin: '[$#]?(?:\\b_*[a-z][_a-zA-Z0-9]*\\b)',
          beginCaptures: {0: {name: 'variable.parameter.c3'}},
          end: '(?=[;,)])',
          patterns: [
            {include: '#comments'},
            {include: '#attribute'},
    ...
    raw_string_literal: {
      ...
      endCaptures: {0: {name: 'punctuation.definition.string.end.c3'}},
      name: 'string.quoted.other.c3',
      patterns: [{match: '``', name: 'constant.character.escape.c3'}]
    },
    real_literal: {
      patterns: [
        {
        ...
        {
          match:
            '\\b(?:[0-9](?:_?[0-9])*[Ee][+-]?[0-9]+|[0-9](?:_?[0-9])*\\.(?!\\.)(?:[0-9](?:_?[0-9])*)?(?:[Ee][+-]?[0-9]+)?)(?:[Ff](?:16|32|64|128)?|[Dd])?',
          name: 'constant.numeric.float.c3'
        },
        {
          match:
            '\\b0[xX][a-fA-F0-9](?:_?[a-fA-F0-9])*(?:\\.(?:[a-fA-F0-9](?:_?[a-fA-F0-9])*)?)?[Pp][+-]?[0-9]+(?:[Ff](?:16|32|64|128)?|[Dd])?',
          name: 'constant.numeric.float.c3'
        }
      ]
    },
    statements: {
      patterns: [
        ...
        {match: ';', name: 'punctuation.terminator.c3'},
    ...
    top_level: {
      patterns: [
        ...
        {include: '#modifier_keywords'},
        {
          ...
          beginCaptures: {0: {name: 'keyword.other.c3'}},
          end: ';',
          endCaptures: {0: {name: 'punctuation.terminator.c3'}},
          patterns: [{include: '#comments'}, {include: '#expression'}]
        },
        {
          begin: '\\bmodule\\b',
          beginCaptures: {0: {name: 'keyword.declaration.module.c3'}},
          end: ';',
          endCaptures: {0: {name: 'punctuation.terminator.c3'}},
          name: 'meta.module.c3',
          patterns: [
        ...
        {
          begin: '\\bimport\\b',
          beginCaptures: {0: {name: 'keyword.declaration.import.c3'}},
          end: ';',
          endCaptures: {0: {name: 'punctuation.terminator.c3'}},
          name: 'meta.import.c3',
          patterns: [
        ...
        {
          begin: '\\balias\\b',
          beginCaptures: {0: {name: 'keyword.declaration.alias.c3'}},
          end: ';',
          endCaptures: {0: {name: 'punctuation.terminator.c3'}},
          name: 'meta.alias.c3',
          patterns: [
            ...
            {
              begin:
                '(@(?:\\b_*[a-z][_a-zA-Z0-9]*\\b))|((?:\\b_*[a-z][_a-zA-Z0-9]*\\b))|((?:\\b_*[A-Z][_A-Z0-9]*\\b))',
              beginCaptures: {
            ...
            {
              begin: '(?:\\b_*[A-Z][_A-Z0-9]*[a-z][_a-zA-Z0-9]*\\b)',
              beginCaptures: {0: {name: 'entity.name.type.c3'}},
              end: '(?=;)',
              patterns: [
                {include: '#comments'},
                {include: '#generic_params'},
        ...
        {
          begin: '\\btypedef\\b',
          beginCaptures: {0: {name: 'keyword.declaration.typedef.c3'}},
          end: ';',
          endCaptures: {0: {name: 'punctuation.terminator.c3'}},
        ...
        {
          begin: '\\bfaultdef\\b',
          beginCaptures: {0: {name: 'keyword.declaration.faultdef.c3'}},
          end: ';',
          endCaptures: {0: {name: 'punctuation.terminator.c3'}},
        ...
        {
          begin: '\\battrdef\\b',
          beginCaptures: {0: {name: 'keyword.declaration.attrdef.c3'}},
          end: ';',
          endCaptures: {0: {name: 'punctuation.terminator.c3'}},
        ...
        },
        {
          ...
          patterns: [
            {
              begin: '\\binterface\\b',
              beginCaptures: {0: {name: 'keyword.declaration.interface.c3'}},
              end: '(?=\\{)',
